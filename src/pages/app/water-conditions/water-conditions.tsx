...
import { WaterConditionTableFilter } from './water-condition-table-filter'
import { WaterConditionTableRow } from './water-condition-table-row'
  ...
  return (
    <>
      ...
      <div className='flex flex-col gap-4'>
        <h1 className='text-3xl font-bold tracking-tight'>Water conditions</h1>
      

        <div className='flex flex-col gap-3'>
          <WaterConditionTableFilter />
